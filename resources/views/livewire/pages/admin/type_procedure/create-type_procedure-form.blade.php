...
new #[Layout('layouts.admin')] class extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->form->area = $this->areas->first()->id;
        $this->form->category = $this->categories->first()->id;
    }
      ...
      <div class="p-5 space-y-3">
        ...
        <div>
          ...
          <div class="flex gap-3" wire:ignore>
            <select wire:model.lazy="form.requirements" name="requirements" id="requirements" class="block w-full" multiple>
            </select>
  ...
  @script
    ...
    <script data-navigate-once>
      document.addEventListener("livewire:navigated", () => {
        ...
        $('#requirements').on('change', function (e) {
          var data = $(this).val();
