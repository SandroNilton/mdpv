...
use App\Livewire\Admin\Forms\requirement\RequirementForm;
...
new #[Layout('layouts.admin')] class extends Component
{
    ...
    public function create(): void
    {
        $this->form->validate();
        $this->form->store();
        $this->redirect(route('admin.requirements.index'), navigate: true);
    }
}; ?>
...
<section>
  <div class="flex flex-col bg-white border border-[#00000020] rounded shadow">
    <div class="card-header text-[#1f2d3d] bg-[#f8f9fa] border-b border-[#00000020] py-3 px-5 rounded-t relative">
      <h3 class="float-left m-0 text-base card-title">Parametros de requisito</h3>
    </div>
